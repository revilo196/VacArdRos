#ifndef _ROS_beginner_tutorials_Player_h
#define _ROS_beginner_tutorials_Player_h
...
namespace beginner_tutorials
{
  ...
  class Player : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "beginner_tutorials/Player"; };
